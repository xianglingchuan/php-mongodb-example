...
class Mongo_Database {
  ...
  {
    //echo "<B>*****database*****__construct*****</B><BR>";  
    $this->_name = $name;
  ...
  {
    //echo "<B>*****database*****execute_safe*****</B><BR>";
  ...
  {
    //echo "<B>*****database*****command_safe*****</B><BR>";
  ...
  {
    //echo "<B>*****database*****selectCollection*****</B><BR>";    
    $this->_connected OR $this->connect();
  ...
  {
    //echo "<B>*****database*****getGridFS*****</B><BR>";     
    $this->_connected OR $this->connect();
  ...
  {
    //echo "<B>*****database*****findAndModify*****</B><BR>";  
  ...
  {
    //echo "<B>*****database*****get_auto_increment*****</B><BR>";   
  ...
  {
    //echo "<B>*****database*****set_profiler*****</B><BR>";     
  ...
  {
    //echo "<B>*****database*****profiler_start*****</B><BR>";      
  ...
  {
    //echo "<B>*****database*****profiler_stop*****</B><BR>";        
  ...
  {
    //echo "<B>*****database*****connection*****</B><BR>";    
