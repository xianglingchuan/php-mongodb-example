...
class Mongo_Collection implements Iterator, Countable
{
  ...
  public function db()
  {
      return Mongo_Database::instance($this->name, array("database"=>$this->db));
  ...
  {
    //echo "<B>*****collection*****collection*****</B><BR>";       
  ...
  public function set_option($name, $value)
  {
    ...
    //echo "<B>*****collection*****set_option*****</B><BR>";   
  ...
  {
    //echo "<B>*****collection*****is_iterating*****</B><BR>";   
    if( ! $this->_cursor) {
      return FALSE;
    }
  ...
  {
    //echo "<B>*****collection*****findOne*****</B><BR>";  
  ...
  {
    //echo "<B>*****collection*****get_auto_increment*****</B><BR>";      
  ...
  {
    //echo "<B>*****collection*****update_safe*****</B><BR>";        
  ...
  {
    //echo "<B>*****collection*****remove_safe*****</B><BR>";         
    $writeConcern = $this->db()->db()->w == 0 ? 1 : $this->db()->db()->w;
  ...
  {
    //echo "<B>*****collection*****as_array*****</B><BR>"; 
    //var_dump($objects);
    $array = array();
    ...
    if($objects)
    {
      ...
      {
        //echo "key:{$key},  value:".var_dump($value)."<BR>";
        $array[$key] = $value;
      }
      //echo "end=====<BR>";
    }
  ...
  {
    //echo "<B>*****collection*****select_list*****</B><BR>";         
    if($val === NULL)
    {
      $val = $key;
      $key = NULL;
  ...
  {
    //echo "<B>*****collection*****natural_join*****</B><BR>";       
    if( ! $id_field) {
  ...
  {
    //echo "<B>*****collection*****inspect*****</B><BR>";       
    $query = array();
    if($this->_query) {
  ...
  {
    //echo "<B>*****collection*****array_merge_recursive_distinct*****</B><BR>";     
    if( ! count($array1)) {
      return $array2;
    }
  ...
  {
    //echo "<B>*****collection*****geoNear*****</B><BR>";   
    $options = array_merge(
  ...
  {
    //echo "<B>*****collection*****mapReduce*****</B><BR>";        
  ...
  {
    //echo "<B>*****collection*****emptyCapped*****</B><BR>";        
    return $this->db()->command_safe(array(
